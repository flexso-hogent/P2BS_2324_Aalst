  ...
  function (Controller, JSONModel, MessageToast, UIComponent) {
    ...
    return Controller.extend("flexso.controller.CreateSession", {
      ...
      onCreateSession: function () {
        ...
        var eventID = selectedEvent.getBindingContext("eventModel").getProperty("eventID");
        ...
        jQuery.ajax({
            ...
            method: "GET",
            success: function (data) {
                var latestSessionID = data.value.length > 0 ? data.value[0].sessionID : 0;
                ...
                var oSessionData = {
                    ...
                    startDate: that.formatDate(oView.byId("_IDGenDatePicker1").getValue()),
                    endDate: that.formatDate(oView.byId("_IDGenDatePicker2").getValue()),
                    startTime: that.formatTime(oView.byId("_IDGenTimePicker1").getValue()),
                    endTime: that.formatTime(oView.byId("_IDGenTimePicker2").getValue()),
